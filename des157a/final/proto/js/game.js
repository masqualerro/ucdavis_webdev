(function () {
	...
	document.addEventListener('keydown', function (e) {
		if (
			e.key === 'Escape' &&
			catImg.src == 'https://masqualerro.github.io/des157a/final/proto/game/images/catz.jpg'
		) {
			catImg.className = 'start';
			...
			e.key === 'Escape' &&
			catImg.src == 'https://masqualerro.github.io/des157a/final/proto/game/images/stand.jpg'
		) {
			catImg.className = 'start';
			catImg.style.height = '100%';
			stand1.style.visibility = 'visible';
			...
			e.key === 'Escape' &&
			catImg.src == 'https://masqualerro.github.io/des157a/final/proto/game/images/walk.jpg'
		) {
			catImg.className = 'start';
			catImg.style.height = '100%';
			walk1.style.visibility = 'visible';
